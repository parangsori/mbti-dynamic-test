...
const TONE_CONFIG = {
  'child': {
    ...
    tempoMessages: [
      '처음 느낌대로 골라봐도 좋아!',
      '어려운 건 없어. 더 끌리는 쪽이면 돼',
      '잘하고 있어. 오늘 마음이 조금씩 보여',
      '이번엔 평소 나라면 어떨지 떠올려봐',
      '중간쯤 왔어. 지금처럼 가볍게 가보자',
      '답들이 모이면서 내 스타일이 보이고 있어',
      '조금만 더 하면 오늘의 내가 더 또렷해져',
      '헷갈리면 먼저 눈에 들어온 쪽을 골라봐',
      '거의 다 왔어. 오늘 기분이 잘 담기고 있어',
      '마지막에 가까워졌어. 그대로 이어가면 돼',
      '두 문항 남았어. 느낌을 믿어도 괜찮아',
      '마지막 선택이야. 곧 결과를 볼 수 있어'
    ]
  },
  'teen': {
    label: '10대',
    ...
    tempoMessages: [
      '편하게 골라봐. 첫 느낌도 꽤 정확해',
      '지금 기분에 더 가까운 쪽으로 가보자',
      '오늘의 나랑 맞는 쪽이 슬슬 보일 거야',
      '평소라면 어떻게 할지 가볍게 떠올려봐',
      '중간쯤 왔어. 너무 깊게 고민 안 해도 돼',
      '답변 흐름이 모이면서 결이 잡히고 있어',
      '여기부터는 살짝 더 내 취향이 드러나',
      '헷갈리면 지금 마음이 덜 부담스러운 쪽으로',
      '거의 다 왔어. 오늘 무드가 꽤 보이고 있어',
      '결과 윤곽이 잡히는 중이야. 조금만 더',
      '두 문항 남았어. 느낌대로 밀어도 괜찮아',
      '마지막 선택이야. 곧 오늘의 타입이 나와'
    ]
  },
  '20s': {
    label: '20대',
    ...
    tempoMessages: [
      '지금 느낌 그대로 골라보세요',
      '정답은 없으니 오늘의 쪽으로 가볍게',
      '오늘 기분에 더 가까운 선택을 봐주세요',
      '평소 패턴보다 지금 반응을 먼저 믿어봐요',
      '중간쯤 왔어요. 직감도 좋은 기준이에요',
      '답변 흐름이 모이면서 결이 잡히고 있어요',
      '이제 내 선택 기준이 조금씩 드러나요',
      '헷갈리면 덜 설명해도 납득되는 쪽으로',
      '거의 다 왔어요. 오늘 무드가 선명해져요',
      '결과 윤곽이 잡히고 있어요. 조금만 더',
      '두 문항 남았어요. 느낌대로 이어가도 좋아요',
      '마지막 선택이에요. 곧 결과가 나와요'
    ]
  },
  '30s': {
    ...
    tempoMessages: [
      '지금의 결대로 가볍게 골라보세요',
      '오늘 컨디션 그대로 반영해보세요',
      '평소 판단보다 오늘 반응을 먼저 봐주세요',
      '상황을 떠올렸을 때 더 자연스러운 쪽으로',
      '중간 지점이에요. 선택 기준이 모이고 있어요',
      '답변 흐름이 오늘의 리듬을 만들고 있어요',
      '여기부터는 성향의 기울기가 조금 더 보입니다',
      '헷갈리는 문항도 결과 해석에 조심스럽게 반영돼요',
      '후반부예요. 오늘의 우선순위가 잡히고 있어요',
      '결과의 윤곽이 꽤 선명해지고 있습니다',
      '두 문항 남았습니다. 지금 감각을 유지해보세요',
      '마지막 선택입니다. 곧 결과를 확인할 수 있어요'
    ]
  },
  '40s': {
    label: '40대',
    ...
    tempoMessages: [
      '편하게 골라보세요',
      '오늘 느끼는 쪽으로 가보세요',
      '평소와 오늘 중 더 가까운 반응을 봐주세요',
      '상황을 떠올렸을 때 자연스러운 쪽이면 충분해요',
      '중간쯤 왔습니다. 천천히 봐도 괜찮아요',
      '답변들이 모이면서 오늘의 흐름이 잡히고 있어요',
      '이제 선택 기준이 조금 더 또렷해지고 있습니다',
      '헷갈리는 문항도 오늘 상태를 읽는 단서가 됩니다',
      '후반부예요. 결과 분위기가 보이기 시작해요',
      '거의 다 왔어요. 흐름이 선명해지고 있습니다',
      '두 문항 남았습니다. 편하게 이어가 주세요',
      '마지막 질문이에요. 곧 결과가 나와요'
    ]
  },
  '50s': {
    ...
    tempoMessages: [
      ...
      '지금 느낌에 가까운 쪽을 골라보세요',
      '천천히 봐도 괜찮습니다',
      '평소와 오늘 중 더 자연스러운 반응을 봐주세요',
      '중간쯤 왔습니다. 부담 없이 이어가셔도 됩니다',
      '답변 흐름이 오늘의 성향을 차분히 모으고 있습니다',
      '선택 기준이 조금씩 더 또렷해지고 있습니다',
      '헷갈리는 문항도 오늘 상태를 읽는 데 도움이 됩니다',
      '후반부입니다. 결과의 윤곽이 보이기 시작합니다',
      '거의 다 왔습니다. 오늘의 흐름이 선명해지고 있습니다',
      '두 문항 남았습니다. 지금 감각을 유지해 주세요',
      '마지막 질문입니다. 곧 결과가 나옵니다'
    ]
  }
};
...
export const getPersonalizedTempoMessage = (ageGroup, index, total = 12, defaultMessage) => {
  ...
  if (messages.length >= safeTotal) {
    const mappedIndex = safeTotal === 1
      ? 0
      : Math.round((current - 1) * (messages.length - 1) / (safeTotal - 1));
    return messages[Math.min(mappedIndex, messages.length - 1)] || defaultMessage;
  }
...
const AGE_CONTEXT_HINTS = {
  ...
  '50s': {
    ...
    recovery: '충분히 쉬는 일도 중요한 선택입니다. 오늘은 마음이 조용해지는 쪽을 먼저 두세요.',
...
const HINT_VARIANTS = {
  ...
  age: {
    ...
    '50s': {
      ...
      recovery: ['충분히 쉬는 일도 중요한 선택입니다. 오늘은 마음이 조용해지는 쪽을 먼저 두세요.', '회복은 속도를 늦추는 일이 아니라 내 리듬을 되찾는 일에 가까워요.', '오늘은 몸과 마음이 조용해지는 쪽을 먼저 고르면 다음 선택이 편해질 수 있어요.'],
